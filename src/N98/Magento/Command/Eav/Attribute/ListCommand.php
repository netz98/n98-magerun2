...
class ListCommand extends AbstractMagentoCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($filterType) {
            try {
                $filterEntityType = $this->eavConfig->getEntityType($filterType);
                $this->attributeCollection->setEntityTypeFilter($filterEntityType->getEntityTypeId());
            } catch (\Exception $e) {
        ...
        foreach ($this->attributeCollection as $attribute) {
            ...
            $entityType = $filterEntityType ?: $attribute->getEntityType();
