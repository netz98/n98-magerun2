...
class VariablesCommandTest extends TestCase
{
    ...
    public function testRounding()
    {
        ...
        $this->assertRegExp('~max_binlog_stmt_cache_size," [0-9\.]+[A-Z]{1,2}"~', $commandTester->getDisplay());
        $this->assertRegExp('~myisam_max_sort_file_size,"  [0-9\.]+[A-Z]{1,2}"~', $commandTester->getDisplay());
    }
}