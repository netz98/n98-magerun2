...
*   [deployer-magento2](https://github.com/rafaelstz/deployer-magento2) – Deployer recipe using n98-magerun2 in pipelines for DB dumps, maintenance mode, and deploy steps.
*   [capistrano-magento2](https://github.com/davidalger/capistrano-magento2) – Capistrano gem integrating n98-magerun2 for remote Magento deployment automation.

## Remote execution and messaging
*   [MageComm CLI](https://github.com/furan917/MageComm) – Executes restricted n98-magerun2 commands and inspects archived files via a messaging-driven remote workflow.
*   [Magento 2 Development MCP Server](https://github.com/elgentos/magento2-dev-mcp) – Runs n98-magerun2 commands in the background behind a managed MCP interface.

## Utilities and package sources
*   [magento-cli-util](https://github.com/montikids/magento-cli-util) – CLI helpers built on n98-magerun2 to automate routine store operations.
*   [homebrew-mageutils](https://github.com/fballiano/homebrew-mageutils) – Homebrew tap for Magento utilities (ExtDN_Installer, n98-magerun, n98-magerun2, pestle) on macOS.
