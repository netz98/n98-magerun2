...
- [admin:user:activate](./admin-user-activate.md) - Activate an admin user
- [admin:user:change-password](./admin-user-change-password.md) - Change admin user password
- [admin:user:change-status](./admin-user-change-status.md) - Change admin user status
- [admin:user:deactivate](./admin-user-deactivate.md) - Deactivate an admin user
